...
if length(UvData.Object)>= IndexObj && isfield(UvData.Object{IndexObj},'plotaxes')&& ishandle(UvData.Object{IndexObj}.plotaxes)
    plot_field(ProjData,UvData.Object{IndexObj}.plotaxes,PlotHandles);
else
