...
num_i1=str2double(i1_str);
num_i2=str2double(i2_str);
num_j1=str2double(j1_str);
num_j2=str2double(j2_str);
...
if ~isempty(ext_input)&&(~isempty(imformats(ext_input(2:end)))||strcmpi(ext_input,'.avi'))% if the extension corresponds to an image or movie format recognized by Matlab
    ...
    if ~isempty(num_i2)
        num_ref_i=floor((num_ref_i+num_i2)/2);% reference image number corresponding to the file
        browse.incr_pair(1)=num_i2-num_i1;
        browse.incr_pair(2)=0;
    end
...
for ifile=1:nbfield
    for j=1:nbslice
        ...
        if Param.CheckCiv1
            ...
            if size(time,1)>=num2_civ1(ifile) && size(time,1)>=num_b_civ1(ifile)
       ...
       case 'oar' %oar-dispatch.pl
        ...
        case 'oar_mpi'
                ...
                text_oarscript=[...
                    ...
                    'WORKDIR=/home/users/gostiaux/tmp/begou \n'...
                    'COMMANDE="/home/users/gostiaux/tmp/begou/mpilauncher  -f ' filename_joblist '" \n'...
                    '# ========================================================= \n'...
                    ...
                    '#========== Bidouille ============== \n'...
                    'export OMPI_MCA_plm_rsh_agent=$HOME/tmp/begou/oarshmost \n'...
                    'cd $WORKDIR \n'...
...
% % mode_value=get(handles.ListPairMode,'Value');
% % mode=mode_list{mode_value};
% find_netcpair_civ2(handles);% update the menu of pairs depending on the available netcdf files
% 
% %------------------------------------------------------------------------
