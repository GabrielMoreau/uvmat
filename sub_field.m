...
Field.VarDimName(check_char)=num2cell(Field.VarDimName(check_char)); %transform each individual dimension 'DimName' into its cell {'DimName'}
check_char=cellfun(@ischar,Field.VarDimName);% look for dimension name defined by a char strings in the list Data.VarDimName
Field_1.VarDimName(check_char)=num2cell(Field_1.VarDimName(check_char)); %transform each individual dimension 'DimName' into its cell {'DimName'}
