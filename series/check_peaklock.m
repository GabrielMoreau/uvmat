...
spli=spline4(aa,mini,nbb);  %appel � la fonction spline4
histsmooth=exp(spli);
...
%data
% n=10;% r�solution de la pdf: nbre de points par unite de u
...
nint=siz(2);
maxi=mini+nint-1;
npdf=nint*n;% nbre total d'intervals � introduire dans la pdf: hist(u,npdf)
%simulation de pdf
