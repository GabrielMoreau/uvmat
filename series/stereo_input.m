...
% end
set(handles.CheckFix3,'parent',handles.civ_input)% put the uicontrol outside the panel
set(handles.CheckPatch3,'parent',handles.civ_input)
set(handles.CheckFix3,'Position',[7 180 74 20])
set(handles.CheckPatch3,'Position',[7 120 74 20])
...
update_CivOptions(handles,ind_opening+1)% fill the menu of possible pairs
% % end
...
%% Civ1 parameters
Param.Civ1.CorrBoxSize=[101 101];
Param.Civ1.SearchBoxSize=[100 100];
...
%% Patch1 parameters
Param.Patch1.FieldSmooth=1000;
Param.Patch1.MaxDiff=3;
Param.Patch1.SubDomainSize=1000;
Param.Patch1.TestPatch1=0;

%% Civ2 parameters
Param.Civ2.CorrBoxSize=[101 101];
Param.Civ2.SearchBoxSize=[10 10];
...
%% Patch2 parameters
Param.Patch2.FieldSmooth=1000;
Param.Patch2.MaxDiff=2;
...
options={'Civ1','Fix1','Patch1','Civ2','Fix2','Patch2','Civ3','Patch3','Patch3'};
for ilist=1:min(ind_input,length(options))
%     if checkbox(ilist)
...
set(handles.num_Maxtanh,'Visible',status)
set(handles.ConfigSource,'String','NEW')
set(handles.OK,'BackgroundColor',[1 0 1])
